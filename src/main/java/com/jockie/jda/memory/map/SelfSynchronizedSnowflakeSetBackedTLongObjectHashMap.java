...
/**
 * This is the equivalent of creating a {@link SynchronizedSnowflakeSetBackedTLongObjectHashMap} without a
 ...
 */
public class SelfSynchronizedSnowflakeSetBackedTLongObjectHashMap<T extends ISnowflake> extends SnowflakeSetBackedTLongObjectHashMap<T> implements Serializable {
	
	public SelfSynchronizedSnowflakeSetBackedTLongObjectHashMap() {
		super();
	}
	
	public SelfSynchronizedSnowflakeSetBackedTLongObjectHashMap(int initialCapacity) {
		super(initialCapacity);
	}
	
	public SelfSynchronizedSnowflakeSetBackedTLongObjectHashMap(int initialCapacity, float loadFactor) {
