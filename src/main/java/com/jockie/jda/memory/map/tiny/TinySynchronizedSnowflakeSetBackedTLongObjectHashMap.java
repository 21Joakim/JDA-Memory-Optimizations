 ...
 * {@link TinySnowflakeSetBackedTLongObjectHashMap} with one key change, {@link #keySet()} and {@link #valueCollection()}
 ...
 */
public class TinySynchronizedSnowflakeSetBackedTLongObjectHashMap<T extends ISnowflake> extends TinySnowflakeSetBackedTLongObjectHashMap<T> implements Serializable {
	
	protected final Object mutex;
	
	public TinySynchronizedSnowflakeSetBackedTLongObjectHashMap() {
		super();
		
		this.mutex = this;
	}
	
	public TinySynchronizedSnowflakeSetBackedTLongObjectHashMap(int initialCapacity) {
		super(initialCapacity);
		
		this.mutex = this;
	}
	
	public TinySynchronizedSnowflakeSetBackedTLongObjectHashMap(int initialCapacity, float loadFactor) {
		super(initialCapacity, loadFactor);
		
		this.mutex = this;
	}
	
	public TinySynchronizedSnowflakeSetBackedTLongObjectHashMap(Object mutex) {
		super();
		
		this.mutex = mutex;
	}
	
	public TinySynchronizedSnowflakeSetBackedTLongObjectHashMap(int initialCapacity, Object mutex) {
		super(initialCapacity);
		
		this.mutex = mutex;
	}
	
	public TinySynchronizedSnowflakeSetBackedTLongObjectHashMap(int initialCapacity, float loadFactor, Object mutex) {
		super(initialCapacity, loadFactor);
