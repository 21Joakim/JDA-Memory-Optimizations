 ...
 */
abstract public class TinyTObjectHash<T> extends TinyTHash {
     ...
     */
    public TinyTObjectHash(int initialCapacity) {
     ...
     */
    public TinyTObjectHash(int initialCapacity, float loadFactor) {
